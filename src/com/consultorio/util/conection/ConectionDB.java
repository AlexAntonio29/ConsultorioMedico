        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            if (conn != null) {
                ...
                String sql = "CREATE TABLE IF NOT EXISTS edificio ( "
                        ...
                        + "numeroEdificio TEXT NOT NULL, "
                        + "nombreEdificio TEXT NOT NULL, "
                        + "direccion TEXT NOT NULL, "
                        + "numeroPisos TEXT, "
                        + "UNIQUE(numeroEdificio, nombreEdificio, direccion) "
                        + "); "
                        ...
                        + "id INTEGER PRIMARY KEY AUTOINCREMENT, "
                        + "id_usuario_agregado INTEGER, "
                        + "id_usuario_responsable INTEGER, "
                        + "fecha_registro DATE, "
                        + " FOREIGN KEY (id_usuario_agregado) REFERENCES usuario (id) ON DELETE CASCADE ON UPDATE CASCADE, "
                        + "FOREIGN KEY (id_usuario_responsable) REFERENCES usuario (id) ON DELETE CASCADE ON UPDATE CASCADE "
                        + ");"
                        + "CREATE TABLE IF NOT EXISTS registro_edificio ( "
                        + "id INTEGER PRIMARY KEY AUTOINCREMENT, "
                        + "id_usuario INTEGER NOT NULL, "
                        + "id_edificio INTEGER NOT NULL, "
                        + "fecha_registro DATE NOT NULL, "
                        + "UNIQUE(id_usuario,id_edificio), "
                        + "FOREIGN KEY (id_edificio) REFERENCES edificio(id) ON DELETE CASCADE ON UPDATE CASCADE, "
                        + "FOREIGN KEY (id_usuario) REFERENCES usuario(id) ON DELETE CASCADE ON UPDATE CASCADE "
                        + "); "
                        + "CREATE TABLE IF NOT EXISTS registro_consultorio ( "
                        + "id INTEGER PRIMARY KEY AUTOINCREMENT, "
                        + "id_usuario INTEGER NOT NULL, "
                        + "nConsultorio TEXT NOT NULL, "
                        + "fecha_registro DATE, "
                        + "UNIQUE(id_usuario,nConsultorio), "
                        + "FOREIGN KEY (nConsultorio) REFERENCES consultorio(nConsultorio) ON DELETE CASCADE ON UPDATE CASCADE, "
                        + "FOREIGN KEY (id_usuario) REFERENCES usuario(id) ON DELETE CASCADE ON UPDATE CASCADE "
                        + "); "
