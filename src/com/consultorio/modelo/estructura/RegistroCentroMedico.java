...
public class RegistroCentroMedico {
    private String id;
    ...
    // Constructor vacío
    public RegistroCentroMedico() {}

    // Constructor con parámetros
    public RegistroCentroMedico(String id, String idUsuario, String nConsultorio, Date fechaRegistro) {
        this.id = id;
